...
import com.archeocomp.silentdrive.cpm.DiskParameters8k;
...
@ContextConfiguration(classes = {DiskEmulatorImpl.class, Directory.class,
     DiskParameters8k.class})
@SpringBootTest
public class Directory8kBlockTest {
